          ...
          <div className="flex flex-wrap">
              <div className="flex relative justify-between p-4  sm:h-[400px] sm:w-screen lg:w-screen lg:h-[400px]">
                  ...
                  <div className="z-10 relative flex flex-col p-4 gap-4">
                    <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold text-green-900 p-4 py-4">CS Country Club</h1>
                    <p className="text-lg sm:text-lg lg:text-4xl font-extralight text-neutral-700 px-4 py-4`">
                    ...
                    <a href="/apply" className="flex items-center justify-center block sm:w-auto sm:h-[36px] bg-green-button text-white font-light text-lg sm:text-xl lg:w-[400px] lg:h-[78px]  rounded-md py-3 px-2 transition-all hover:shadow-lg active:opacity-85">
                      ...
                      <p className="sm:text-md lg:text-3xl font-extralight text-neutral-700 px-4">
